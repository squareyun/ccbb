...
export default function LoLvoteDetailPage() {
    ...
    const dummyData = [{
        title : '이거 내잘못임??',
        content : '아니 어쩌구저쩌구어쩌구저쩌구어쩌구저쩌구어쩌구저쩌구어쩌구저쩌구어쩌구저쩌구 그래서 내가 잘못임?'
        ...
        <S.Main>
            ...
            <S.Votebodycover>
                <S.Menuhead>
                    ...
                    <S.HeadRight>
                        <img src="../resource/silver.png" alt="" style={{height:'100px',paddingRight:'50px'}} />
                    </S.HeadRight>
                </S.Menuhead>
                <S.DetailBody>
                    <S.Moviebody>
                        <ReactPlayer
                            ...
                            width="80%"
                            height=""
                            style={{border:'3px solid #ccc', borderRadius: '30px', overflow: 'hidden' }}
                        />
                    </S.Moviebody>
                        ...
                        <S.VoteBodybot>
                            ...
                            <S.Votebutton>
                                <S.ProfileBox backgroundColor="#97A7FF">
                                    ...
                                    <S.ImgTier src="../resource/silver.png" alt="VS Logo" style={{height:'50px'}}/>
                                </S.ProfileBox>
                                <S.ImgVS src="../resource/VSlogo.png" alt="VS Logo" style={{height:'50px'}}/>
                                <S.ProfileBox backgroundColor="#FF9797">
                                    <UserProfile name={"브우혁"} color={"black"}/>
                                    <S.ImgTier src="../resource/challenger.png" alt="VS Logo" style={{height:'50px'}}/>
                                </S.ProfileBox>
                            </S.Votebutton>
                            <S.ArticleMenu>

                                {isThumbUp ? (
                                    <ThumbUpAltIcon onClick={toggleThumbUp} style={{fontSize:'50px',cursor:'pointer'}}/>
                                    ) : (
                                    <ThumbUpOffAltIcon onClick={toggleThumbUp} style={{fontSize:'50px',cursor:'pointer'}}/>
                                )}
                                
                                
                                {isWard ? (
                                    <S.Imgward onClick={toggleWard} src="../resource/wardafter.png" alt="VS Logo" style={{height:'80px',cursor:'pointer'}}/>
                                ) : (
                                    <S.Imgward onClick={toggleWard} src="../resource/wardbefore.png" alt="VS Logo" style={{height:'80px',cursor:'pointer'}}/>
                                )}

                                {isThumbDown ? (
                                    <ThumbDownAltIcon onClick={toggleThumbDown} style={{fontSize:'50px',cursor:'pointer'}}/>
                                    ) : (
                                    <ThumbDownOffAltIcon onClick={toggleThumbDown} style={{fontSize:'50px',cursor:'pointer'}}/>
                                )}
