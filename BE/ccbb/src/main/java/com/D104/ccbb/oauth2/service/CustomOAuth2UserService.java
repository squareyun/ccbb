package com.D104.ccbb.oauth2.service;
...
import com.D104.ccbb.oauth2.CustomOAuth2User;
import com.D104.ccbb.oauth2.OAuthAttributes;
import com.D104.ccbb.oauth2.userinfo.KakaoOAuth2UserInfo;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	...
	private User saveUser(OAuthAttributes attributes) {
		...
		createdUser.setPassword(UUID.randomUUID().toString());
